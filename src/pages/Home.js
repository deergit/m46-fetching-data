...
const Home = () => {
    return (
        <div className="Page">
            ...
            <Image src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/51/20070622_Art_Institute_of_Chicago_Front_View.JPG/1920px-20070622_Art_Institute_of_Chicago_Front_View.JPG" alt="the chicago art institute building"></Image>
            <Wrapper>
                <h2>what a nice building</h2>
                <h3>GREAT bricks</h3>
            </Wrapper>
        </div>
    )
